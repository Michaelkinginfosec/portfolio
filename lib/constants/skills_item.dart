const List<Map> platformItems = [
  {"img": "assets/images/android-robot-bot-icon.png", "title": "Android Dev"},
  {"img": "assets/images/apple-icon.png", "title": "IOS Dev"},
  {"img": "assets/images/flutter-icon.png", "title": "App Deployment"},
  {"img": "assets/images/flutter-icon.png", "title": "App Maintenance"},
  {"img": "assets/images/node-js-icon.png", "title": "Backend Dev"},
  {"img": "assets/images/postgresql-icon.png", "title": "Database"},
];
